        ...
        <section id='About' className='custom-space text-light'  >
            ...
            <Container fluid>
                <Row className='align-items-center'>
                    ...
                    {/* Text Side */}
                   <Col xs={12} md={6} className="mb-4 mb-md-0 text-start pe-md-5 order-2 order-md-1">
                        <h2 className="fw-semibold mt-5 mt-lg-0 text-start ">
                            Exquisite Dining Experience Fit for <br className='d-none d-md-block' />
                            <span className='highlight'>Royalty</span>
                        </h2>

                        <p className="mt-3">
                            Welcome to our restaurant, where culinary artistry meets exceptional dining <br />
                        ...
                        <p className="mt-3 mb-4">
                            Lorem to our restaurant, where culinary artistry meets exceptional dining <br /> experiences. At, we strive to create a gastronomic haven that.
                        </p>
