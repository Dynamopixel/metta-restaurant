        ...
        <Container className="menu-items py-5">
          <Row className="g-5">
            {currentItems.map((item, index) => (
              <Col md={6} key={index} className="menu-item-row">
                <div className="menu-item d-flex justify-content-between align-items-start">
                  <div className="menu-left">
                    <h5 className="menu-name">{item.name}</h5>
                    <p className="menu-desc text-white">{item.desc}</p>
                  </div>
                  <div className="menu-right text-end">
                    <div className="menu-price">${item.price}</div>
                    <p className="menu-extra text-white">Extra free juice</p>
                  </div>
                </div>
